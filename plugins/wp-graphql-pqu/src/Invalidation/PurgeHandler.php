 ...
 *
 * @package WPGraphQL\PQU\Invalidation
 * @since 0.1.0-beta.1
 */

namespace WPGraphQL\PQU\Invalidation;

use WPGraphQL\PQU\Purge\AdapterFactory;
...
class PurgeHandler {
	...
	public function handle_purge( string $key, string $event = '', string $hostname = '' ): void {
		 ...
		 * @return bool
		 */
		$delete_entries = apply_filters( 'wpgraphql_pqu_delete_entries_on_purge', true, $key, $urls );
