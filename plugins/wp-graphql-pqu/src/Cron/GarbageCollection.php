 ...
 *
 * @package WPGraphQL\PQU\Cron
 * @since 0.1.0-beta.1
 */

namespace WPGraphQL\PQU\Cron;
...
class GarbageCollection {
	...
	public function init(): void {
		add_action( 'wpgraphql_pqu_garbage_collection', [ $this, 'run' ] );
	}
	...
	public function run(): void {
		...
		$ttl_days = apply_filters( 'wpgraphql_pqu_ttl_days', 7 );
