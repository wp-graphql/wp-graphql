<?php
/**
 * Database schema for Persisted Query URLs tables (documents, executions, normalized key map).
 *
 * @package WPGraphQL\PQU\Database
 * @since 0.1.0-beta.1
 */

namespace WPGraphQL\PQU\Database;
...
class Schema {
	 ...
	 */
	private const LEGACY_URL_KEYS_SUFFIX = 'wpgraphql_pqu_url_keys';
	...
	public static function get_documents_table_name(): string {
		...
		return $wpdb->prefix . 'wpgraphql_pqu_documents';
	}
	...
	public static function get_urls_table_name(): string {
		...
		return $wpdb->prefix . 'wpgraphql_pqu_urls';
	}
	...
	public static function get_cache_keys_table_name(): string {
		...
		return $wpdb->prefix . 'wpgraphql_pqu_cache_keys';
	}
	...
	public static function get_key_urls_table_name(): string {
		...
		return $wpdb->prefix . 'wpgraphql_pqu_key_urls';
	}
	...
	public static function get_executions_table_name(): string {
		...
		return $wpdb->prefix . 'wpgraphql_pqu_executions';
	}
	...
	public static function get_db_version(): string {
		return get_option( 'wpgraphql_pqu_db_version', '0' );
	}
	...
	public static function update_db_version( string $version ): void {
		update_option( 'wpgraphql_pqu_db_version', $version );
	}
}
