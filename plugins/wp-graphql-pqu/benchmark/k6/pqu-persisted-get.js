/**
 * k6: load persisted GET URLs (edge or origin).
 *
 ...
 *   -e REQUIRE_X_CACHE=1
 *
 * Origin baseline (BASE_URL :8888): omit REQUIRE_X_CACHE; X-Cache is usually absent → pqu_x_cache_unknown.
 */
...
const responseTime = new Trend("pqu_get_duration", true);
const xCacheHits = new Counter("pqu_x_cache_hits");
const xCacheMisses = new Counter("pqu_x_cache_misses");
const xCacheUnknown = new Counter("pqu_x_cache_unknown");
const xCacheHitRate = new Rate("pqu_x_cache_hit_rate");
