...
Guidance for AI coding agents working in this plugin. The repo-root `AGENTS.md` covers the monorepo; this file covers wp-graphql-ide specifics.
...
- **Requirements**: PHP 7.4+, WordPress 6.1+, WPGraphQL active.
