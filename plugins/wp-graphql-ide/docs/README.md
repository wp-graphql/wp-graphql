...
- [Internationalization](./internationalization.md) — textdomain, how WordPress loads translations, and the gaps still to wire (`wp_set_script_translations` for the React app).
