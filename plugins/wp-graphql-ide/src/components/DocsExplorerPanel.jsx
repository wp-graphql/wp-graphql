...
function FieldsList({ fields, onSelectType }) {
	return (
		<div className="wpgraphql-ide-docs-section">
			...
			{fields.map((field) => (
				<div key={field.name} className="wpgraphql-ide-docs-field">
					<div className="wpgraphql-ide-docs-field-header">
						...
						<button
							...
							onClick={() =>
								onSelectType(getNamedType(field.type))
							}
						>
					...
					{field.args && field.args.length > 0 && (
						<div className="wpgraphql-ide-docs-args">
							{field.args.map((arg) => (
								<div
									key={arg.name}
									className="wpgraphql-ide-docs-arg"
								>
 ...
 * @param {Function} props.onClick Click handler.
 */
function TypeLink({ label, type, onClick }) {
	return (
