...
Guidance for AI coding agents working in the WPGraphQL Smart Cache plugin. The repo-root `AGENTS.md` covers the monorepo and shared conventions; this file covers `plugins/wp-graphql-smart-cache/`. Workspace: `@wpgraphql/wp-graphql-smart-cache`.
