...
class CustomTaxonomyRegistrationCest {
	...
	public function testTaxonomyCanBeRegisteredToShowInGraphql( FunctionalTester $I ) {
		...
		// Get the form values
		$graphql_single_name_value = $I->grabAttributeFrom( '//input[@name="acf_taxonomy[graphql_single_name]"]', 'value' );
		$graphql_plural_name_value = $I->grabAttributeFrom( '//input[@name="acf_taxonomy[graphql_plural_name]"]', 'value' );
		...
		// fill out the form
		$I->fillField( '//input[@name="acf_taxonomy[labels][singular_name]"]', 'Test Type' );
		$I->fillField( '//input[@name="acf_taxonomy[labels][name]"]', 'Test Types' );
		$I->fillField( '//input[@name="acf_taxonomy[taxonomy]"]', 'test_type' );
		...
		$singular_label = $I->grabAttributeFrom( '//input[@name="acf_taxonomy[labels][singular_name]"]', 'value' );
		$plural_label = $I->grabAttributeFrom( '//input[@name="acf_taxonomy[labels][name]"]', 'value' );
		$taxonomy_key = $I->grabAttributeFrom( '//input[@name="acf_taxonomy[taxonomy]"]', 'value' );
		...
		$I->assertSame( 'test_type', $taxonomy_key );
