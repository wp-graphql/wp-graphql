# wp-graphql-pqc status

**Version:** 0.1.0-beta.1 (experimental). This document is the living snapshot of what works, what is untested, and known limits. It will be expanded as the plugin matures.
