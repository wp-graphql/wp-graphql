...
abstract class AbstractConnectionResolver {
	...
	public function get_page_info() {
		if ( ! isset( $this->page_info ) ) {
			 ...
			 * });
			 *
			 * @param array<string,mixed> $page_info The pageInfo payload for the connection.
	...
	public function get_connection() {
		...
		return new Deferred(
			function () {
				 ...
				 */
				$connection = apply_filters( 'graphql_connection_resolved', $connection, $this );
				if ( has_filter( 'graphql_connection' ) ) {
					$connection = apply_filters_deprecated(
						'graphql_connection',
						[ $connection, $this ],
