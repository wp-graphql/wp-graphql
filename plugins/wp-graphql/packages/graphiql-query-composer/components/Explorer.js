        ...
        description={
          <div>
            ...
            {hasUrlMismatch && (
              ...
              >
                <strong style={{ color: "#d46b08" }}>URL Mismatch Detected</strong>
                <p style={{ margin: "8px 0 0 0", fontSize: "12px" }}>
                  You are accessing the admin at{" "}
                  <code>{error.urlMismatch.currentOrigin}</code> but the GraphQL
                  endpoint is configured for{" "}
                  <code>{error.urlMismatch.endpointOrigin}</code>.
                </p>
                <p style={{ margin: "8px 0 0 0", fontSize: "12px" }}>
                  This commonly occurs with local development tools (like LocalWP)
                  when WordPress is configured for a custom domain but accessed via
                  localhost.
                </p>
              </div>
            )}
            ...
            {isAuthError && (
              <div style={{ fontSize: "12px", marginTop: "8px" }}>
                ...
                <ul style={{ margin: "0", paddingLeft: "20px" }}>
                  ...
                  <li>Cookie authentication failed - ensure you're logged in</li>
                  {hasUrlMismatch && (
                    <li>
                      URL mismatch preventing cookie/nonce validation (see above)
                    </li>
                  )}
                </ul>
              </div>
