...
describe('Router', () => {
	...
	test('router should render GraphiQL by default', async () => {
		await act(async () => {
			const { queryByTestId, debug, container } = await render(
				<Router />
			);
	...
	test('clicking router menu item changes route to associated screen', async () => {
		...
		expect(queryByTestId('router-screen-help')).not.toBeInTheDocument();
		...
		expect(queryByTestId('router-screen-graphiql')).not.toBeInTheDocument();
...
describe('router filters', () => {
	...
	test('clicking filtered screen menu item should replace screen with filtered screen', async () => {
		...
		expect(queryByTestId('router-screen-testScreen')).toBeInTheDocument();
