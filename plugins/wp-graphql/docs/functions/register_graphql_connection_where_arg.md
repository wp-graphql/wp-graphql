...
-->
---
title: register_graphql_connection_where_arg
docType: function
plugin: wp-graphql
---
...
- [`plugins/wp-graphql/access-functions.php:397`](https://github.com/wp-graphql/wp-graphql/blob/main/plugins/wp-graphql/access-functions.php#L397)
