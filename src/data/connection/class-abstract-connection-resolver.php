...
use WPGraphQL\Data\Loader\Abstract_Data_Loader;
use WPGraphQL\Model\Model;
use WPGraphQL\Model\Post;

/**
 * Class Abstract_Connection_Resolver
 */
abstract class Abstract_Connection_Resolver {
	...
	/**
	 * The unique identifiers for each result.
	 *
	 * @var array
	 */
	protected $ids;
	...
	/**
	 * The number of nodes being retrieved.
	 *
	 * @var int
	 */
	...
	/**
	 * Abstract_Connection_Resolver constructor.
	 *
	 * @param mixed       $source  Root object the connection lives on.
	 ...
	 * Get the loader name
	 *
	 * @throws \Exception Loader not found.
	 *
	 * @return Abstract_Data_Loader
	 */
	 ...
	 * @return bool
	 */
	protected function get_should_execute(): bool {
	 ...
	 *
	 * @param mixed $offset Offset to be validated.
	 *
	 * @return bool
	 */
	 ...
	 *
	 * @throws UserError Invalid input provided to the "first" or "last" args.
	 * @return int|null
	 */
