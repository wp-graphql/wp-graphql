<?php
/**
 * Resolves connections to menu items
 *
...
/**
 * Class Menu_Item_Connection_Resolver
 */
class Menu_Item_Connection_Resolver extends Post_Object_Connection_Resolver {

	/**
	 * Menu_Item_Connection_Resolver constructor.
	 *
	...
	public function get_query_args() {
		...
		$parent_id     = ( $source instanceof MenuItem && 'childItems' === $this->info->fieldName )
			? $source->menuItemId //@codingStandardsIgnoreLine
			: 0;
