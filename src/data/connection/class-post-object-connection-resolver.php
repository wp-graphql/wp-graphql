<?php
/**
 * Resolves connections to post objects.
 *
...
/**
 * Class Post_Object_Connection_Resolver
 */
class Post_Object_Connection_Resolver extends Abstract_Connection_Resolver {
	...
	/**
	 * Return an instance of WP_Query with the args mapped to the query
	 *
	 * @return \WP_Query
	 */
	 ...
	 *
	 * @param string $stati  post status type.
	 *
	 * @return array|null
	 */
