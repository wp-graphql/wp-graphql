<?php
/**
 * Resolves connections to term objects
 *
...
/**
 * Class Term_Object_Connection_Resolver
 */
class Term_Object_Connection_Resolver extends Abstract_Connection_Resolver {
	...
	/**
	 * Term_Object_Connection_Resolver constructor.
	 *
	 * @param mixed       $source    The query results.
	 * @param array       $args      The query arguments.
	 * @param AppContext  $context   The AppContext object.
	 * @param ResolveInfo $info      The ResolveInfo object.
	 * @param string      $taxonomy  Name of the Taxonomy the resolver is intended to be used.
	 */
	...
	/**
	 * Get the connection args to query the term objects.
	 *
	 * @return array
	 */
	public function get_query_args() {
		...
		if ( true === is_object( $this->source ) ) {
			switch ( true ) {
				case $this->source instanceof Post:
					$post                         = $this->source;
					$post->only_include_connected = isset( $input_fields['shouldOnlyIncludeConnectedItems'] )
						? $input_fields['shouldOnlyIncludeConnectedItems']
						: true;
		 ...
		 */
		if ( isset( $post->only_include_connected ) && false === $post->only_include_connected ) {
