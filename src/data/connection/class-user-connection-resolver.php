...
/**
 * Class User_Connection_Resolver
 */
class User_Connection_Resolver extends Abstract_Connection_Resolver {
	...
	protected function sanitize_input_fields( array $args ) {
		 ...
		 */
		if ( ( ! empty( $args['roleIn'] ) || ! empty( $args['roleNotIn'] ) || ! empty( $args['role'] ) )
