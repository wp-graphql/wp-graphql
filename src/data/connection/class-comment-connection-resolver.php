<?php
/**
 * Resolves connections to comments
 *
...
/**
 * Class Comment_Connection_Resolver
 */
class Comment_Connection_Resolver extends Abstract_Connection_Resolver {

	/**
	 * Process query arguments
	 *
	 * @throws UserError Invalid sorting input provided.
	 *
	 * @return array
	 */
	...
	/**
	 * Processes query and retrieves the IDs of the results.
	 *
	 * @return array
	 */
