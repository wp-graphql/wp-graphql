...
class Post_Object_Cursor {
	...
	/**
	 * Builds SQL WHERE conditional statement for WPGraphQL pagination.
	 *
	 * @var Cursor_Builder
	 */
	public $builder;
	...
	public function __construct( $query ) {
		...
		$this->builder = new Cursor_Builder( $compare );
	}
	...
	/**
	 * Returns the value assigned to the request query var.
	 *
	...
	private function compare_with_meta_field( $meta_key, $order ) {
		...
		/**
		 * WordPress uses mt1, mt2 etc. style aliases for additional meta value joins.
		 */
