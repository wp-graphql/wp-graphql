...
class Cursor_Builder {
	...
	/**
	 * Cursor_Builder constructor
	 *
	 * @param string $compare  Direction of pagination. Either < or >.
	 */
	 ...
	 *
	 * @param array $fields  Conditional fields to be used in the resulting SQL statement.
	 *
	 * @return string
	 */
