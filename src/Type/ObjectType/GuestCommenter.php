...
use \WPGraphQL\Model\GuestCommenter as GuestCommenterModel;

class GuestCommenter {

	/**
	 * Register the GuestCommenter Type to the Schema
	 *
	 * @return void
	 */
	public static function register_type() {
		register_graphql_object_type(
			...
			[
				...
				'fields'          => [
					'id'           => [
						'description' => __( 'The globally unique identifier for the guest commenter object', 'wp-graphql' ),
					],
					'name'         => [
						'type'        => 'String',
						'description' => __( 'The name for the guest commenter.', 'wp-graphql' ),
					],
					'email'        => [
						'type'        => 'String',
						'description' => __( 'The email for the guest commenter', 'wp-graphql' ),
					],
					'url'          => [
						'type'        => 'String',
						'description' => __( 'The url the guest commenter.', 'wp-graphql' ),
					],
					'isRestricted' => [
						'type'        => 'Boolean',
