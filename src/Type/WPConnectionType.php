		...
		if ( ! $this->one_to_one && ! $this->type_registry->has_type( $this->to_type . 'Connection' ) ) {
			$this->type_registry->register_interface_type(
				...
				[
					...
					'description' => sprintf( __( 'A paginated collection of %s Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of %s Nodes', 'wp-graphql' ), $this->to_type, $this->to_type ),
					'fields'      => [
						'edges'    => [
