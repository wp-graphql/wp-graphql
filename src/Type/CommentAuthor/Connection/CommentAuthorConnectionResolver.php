...
/**
 * Class CommentAuthorConnectionResolver - Connects the comments to other objects
 *
 * @package WPGraphQL\Data\Resolvers
 */
class CommentAuthorConnectionResolver extends ConnectionResolver {
	...
	public static function get_query_args( $source, array $args, AppContext $context, ResolveInfo $info ) {
		...
		/**
		 * Set the default comment_status for CommentAuthor Queries to be "approved"
		 */
		$query_args['comment_status'] = 'approved';

		/**
		 * Set the default comment_parent for CommentAuthor Queries to be "0" to only get top level comments
		 */
		$query_args['parent'] = 0;
