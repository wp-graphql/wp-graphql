...
/**
 * Class CommentAuthorConnectionDefinition
 * @package WPGraphQL\Type\CommentAuthor\Connection
 * @since 0.0.5
 */
class CommentAuthorConnectionDefinition {
		...
		if ( null === self::$connection ) :
			$connection = Relay::connectionDefinitions( [
				...
				'connectionFields' => function() {
					return [
						'nodes' => [
							'type' => Types::list_of( Types::comment_author() ),
			...
			self::$connection = [
				...
				'description' => __( 'A collection of comment author objects', 'wp-graphql' ),
	...
	private static function args() {
		return self::$args ? : ( self::$args = new CommentAuthorConnectionArgs() );
	}
