...
class RootQuery {
	public static function register_type() {
		...
		register_graphql_type( 'RootQuery', [
			'description' => __( 'The root entry into the Schema', 'wp-graphql' ),
			'fields' => [
				'hello' => [
					'type' => 'String',
					'description' => __( 'Example field that returns \"world\"', 'wp-graphql' ),
				],
				'allSettings' => [
					'type' => 'Settings',
		...
		if ( ! empty( $allowed_setting_types ) && is_array( $allowed_setting_types ) ) {
			foreach ( $allowed_setting_types as $group => $setting_type ) {
				...
				register_graphql_field( 'RootQuery', $setting_type . 'Settings', [
