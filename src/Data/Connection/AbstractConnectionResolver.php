...
abstract class AbstractConnectionResolver {
	 ...
	 * @since @todo
	 *
	 * @throws UserError if child class forgot to implement this.
	 *
	 ...
	 *
	 * This returns the offset for a given cursor.
	 *
	 * @return int|mixed
	 */
	...
	public function has_next_page() {
		...
		if ( ! empty( $this->args['before'] ) ) {
			return $this->is_valid_offset( $this->get_offset_for_cursor( $this->args['before'] ) );
		}
	...
	public function has_previous_page() {
		...
		if ( ! empty( $this->args['after'] ) ) {
			return $this->is_valid_offset( $this->get_offset_for_cursor( $this->args['after'] ) );
		}
