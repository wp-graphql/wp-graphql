...
class DataSource {
	...
	public static function resolve_comment( $id, $context ) {
		_deprecated_function( __METHOD__, '@todo', 'Use $context->get_loader( \'comment\' )->load_deferred( $id ) instead.' );
	...
	public static function resolve_post_object( int $id, AppContext $context ) {
		_deprecated_function( __METHOD__, '@todo', 'Use $context->get_loader( \'post\' )->load_deferred( $id ) instead.' );
	...
	public static function resolve_term_object( $id, AppContext $context ) {
		_deprecated_function( __METHOD__, '@todo', 'Use $context->get_loader( \'term\' )->load_deferred( $id ) instead.' );
	...
	public static function resolve_user( $id, AppContext $context ) {
		_deprecated_function( __METHOD__, '@todo', 'Use $context->get_loader( \'user\' )->load_deferred( $id ) instead.' );
