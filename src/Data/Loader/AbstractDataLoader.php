...
abstract class AbstractDataLoader {
	...
	public function clearAll() {
		_deprecated_function( __METHOD__, '@todo', static::class . '::clear_all()' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	...
	public function loadMany( array $keys, $asArray = false ) {
		_deprecated_function( __METHOD__, '@todo', static::class . '::load_many()' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	...
	protected function keyToScalar( $key ) {
		_deprecated_function( __METHOD__, '@todo', static::class . '::key_to_scalar()' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
