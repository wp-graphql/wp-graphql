 ...
 * Make sure there is a post returned with the data we requested
 */
$I->assertNotEmpty( $response_array['data']['SecondQuery']['edges'][0]['node']['id'] );
$I->assertNotEmpty( $response_array['data']['SecondQuery']['edges'][0]['node']['title'] );
$I->assertNotEmpty( $response_array['data']['SecondQuery']['edges'][0]['node']['link'] );
$I->assertNotEmpty( $response_array['data']['SecondQuery']['edges'][0]['node']['date'] );
