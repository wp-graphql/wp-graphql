...
add_action( 'graphql_register_interfaces', function() {
...
add_action( 'graphql_register_types', function( \WPGraphQL\Registry\TypeRegistry $type_registry ) {
	...
	register_graphql_field( 'RootQuery', 'getType', [
		'type' => 'MyTestType',
		'resolve' => function() {
			return true;
		}
...
//add_action( 'init_graphql_type_registry', function( \WPGraphQL\Registry\TypeRegistry $type_registry ) {
//
//
//	$type = $type_registry->get_type( 'MyTestType')->getFields();
//	var_dump( $type );
//	die();
//
//}, 11 );
