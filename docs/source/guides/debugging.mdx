...
![Screenshot showing debugging with the Chrome network tab](https://github.com/wp-graphql/wp-graphql/blob/master/docs/source/images/wpgraphql-debug-with-network-tab.gif)
