...
<Note type="warning" title="New to WordPress?">
  ...
  using <a href="https://localwp.com/">Local</a>
</Note>
...
- [Firecamp](https://firecamp.io/graphql) - The fastest GraphQL IDE for the team ever.
...
- [Postman](https://www.postman.com/) - Create and execute any REST, SOAP, and GraphQL queries from the within Postman API client.
