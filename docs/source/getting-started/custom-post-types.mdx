...
<Note title="PHP Code Snippets">
The above PHP code snippet can be added to your WordPress Child Theme's functions.php file or other
appropriate file such as a custom plugin that is active on your site.
</Note>
