// =============================================================
// WPGraphQL Product Family — tokens.ts  (v3)
// All four products.
// =============================================================
export const navy = {
...
export const orange = { 600:"#C45C00",500:"#E06A00",400:"#F27800",300:"#FF8C1A",200:"#FFAA4D",100:"#FFD099",50:"#FFF2E0" } as const;
export const cyan   = { 600:"#007A8C",500:"#009AB0",400:"#00B8D4",300:"#00D4F5",200:"#5DE8FF",100:"#AAFAFF",50:"#E0FAFE" } as const;
export const violet = { 700:"#3B1A6B",600:"#4C23A0",500:"#5E2EC4",400:"#7040E8",300:"#8B5CF6",200:"#A78BFA",100:"#C4B5FD",50:"#EDE9FE" } as const;
export const emerald= { 700:"#064E3B",600:"#065F46",500:"#047857",400:"#059669",300:"#10B981",200:"#34D399",100:"#6EE7B7",50:"#ECFDF5" } as const;

export const products = {
  wpgraphql: { accent:orange[300],  markShape:"circle"         as const, cssThemeClass:"" },
  radiql:    { accent:cyan[300],    markShape:"rounded-square" as const, cssThemeClass:"theme-radiql" },
  ide:       { accent:violet[300],  markShape:"rounded-square" as const, cssThemeClass:"theme-ide",  statusBar:violet[500] },
  acf:       { accent:emerald[300], markShape:"rounded-square" as const, cssThemeClass:"theme-acf" },
} as const;
...
// IDE and ACF marks are multi-element — use their respective logo components.
