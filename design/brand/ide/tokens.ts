// =============================================================
// WPGraphQL Product Family — tokens.ts  (v2)
// All three product token sets + shared SVG paths.
// =============================================================

// ── Shared Navy ───────────────────────────────────────────────
export const navy = {
  950: "#080D18", 900: "#0C1220", 800: "#131B30", 700: "#1A2540",
  600: "#223050", 500: "#2A3B60", 400: "#435678", 300: "#6578A0",
  200: "#96A8C8", 100: "#C8D2E8", 50:  "#EDF0F6",
} as const;

// ── WPGraphQL Orange ──────────────────────────────────────────
export const orange = {
  600: "#C45C00", 500: "#E06A00", 400: "#F27800",
  300: "#FF8C1A",  // ← WPGraphQL primary
  200: "#FFAA4D", 100: "#FFD099", 50: "#FFF2E0",
} as const;

// ── RadiQL Cyan ───────────────────────────────────────────────
export const cyan = {
  600: "#007A8C", 500: "#009AB0", 400: "#00B8D4",
  300: "#00D4F5",  // ← RadiQL primary
  200: "#5DE8FF", 100: "#AAFAFF", 50: "#E0FAFE",
} as const;

// ── WPGraphQL IDE Violet ──────────────────────────────────────
export const violet = {
  700: "#3B1A6B", 600: "#4C23A0", 500: "#5E2EC4",
  400: "#7040E8",
  300: "#8B5CF6",  // ← IDE primary
  200: "#A78BFA", 100: "#C4B5FD", 50: "#EDE9FE",
} as const;
...
export const products = {
  wpgraphql: {
    accent:        orange[300],
    accentDim:     orange[500],
    markShape:     "circle" as const,
    cssThemeClass: "",              // default, no class needed
  },
  radiql: {
    accent:        cyan[300],
    accentDim:     cyan[500],
    markShape:     "rounded-square" as const,
    markRadius:    "22.5%",
    cssThemeClass: "theme-radiql",
  },
  ide: {
    accent:        violet[300],
    accentDim:     violet[500],
    statusBar:     violet[500],
    markShape:     "rounded-square" as const,
    markRadius:    "22.5%",
    cssThemeClass: "theme-ide",
  },
} as const;
...
// ── SVG Paths ─────────────────────────────────────────────────
// WPGraphQL elephant — viewBox="0 0 512 512"
export const WPGRAPHQL_ELEPHANT_PATH =
...
// RadiQL lightning bolt — viewBox="0 0 160 160"
export const RADIQL_BOLT_PATH    = "M 100 14 L 56 86 L 80 86 L 60 146 L 108 68 L 82 68 Z";
// Small inline bolt — viewBox="0 0 8 12"
export const RADIQL_BOLT_PATH_SM = "M 5 1 L 1 6.5 L 4 6.5 L 3 11 L 7 5.5 L 4 5.5 Z";

// IDE mark is rendered programmatically in WPGraphQLIDELogoMark component
// (too many elements to reduce to a single path — use the component instead)
