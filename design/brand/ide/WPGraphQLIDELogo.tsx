...
export function WPGraphQLIDELogoMark({
  ...
  const gradId = `ide-grad-${Math.random().toString(36).slice(2, 7)}`;
  ...
  return (
    ...
    >
      ...
      {showGradient && !isReversed && (
        <>
          <rect x="14" y="14" width="132" height="18" rx="4" fill={`url(#${gradId})`} />
          <defs>
            <linearGradient id={gradId} x1="14" y1="14" x2="146" y2="32" gradientUnits="userSpaceOnUse">
      ...
      <rect x="19" y="44" width="36" height="2.5" rx="1.25" fill={queryLine1} opacity="0.7" />
      <rect x="24" y="51" width="44" height="2.5" rx="1.25" fill={queryLine1} opacity="0.55" />
      <rect x="29" y="58" width="32" height="2.5" rx="1.25" fill={queryLine2} opacity="0.45" />
      <rect x="34" y="65" width="22" height="2.5" rx="1.25" fill={queryLine3} opacity="0.5" />
      <rect x="29" y="72" width="30" height="2.5" rx="1.25" fill={queryLine1} opacity="0.4" />
      <rect x="24" y="79" width="36" height="2.5" rx="1.25" fill={queryLine2} opacity="0.35" />
      <rect x="19" y="86" width="20" height="2.5" rx="1.25" fill={queryLine3} opacity="0.4" />

      {/* Right pane: response lines */}
      <rect x="86" y="44" width="20" height="2.5" rx="1.25" fill={respLine1} opacity="0.8" />
      <rect x="91" y="51" width="44" height="2.5" rx="1.25" fill={respLine2} opacity="0.55" />
      <rect x="91" y="58" width="34" height="2.5" rx="1.25" fill={respLine2} opacity="0.45" />
      <rect x="96" y="65" width="38" height="2.5" rx="1.25" fill={respLine1} opacity="0.4" />
      <rect x="96" y="72" width="28" height="2.5" rx="1.25" fill={respLine2} opacity="0.4" />
      <rect x="91" y="79" width="40" height="2.5" rx="1.25" fill={respLine2} opacity="0.35" />

      {/* Status bar */}
      <rect x="14" y="134" width="132" height="12" rx="3" fill={statusBar} opacity="0.75" />
    ...
    <div className={cn("flex items-center gap-3", className)}>
      ...
      {showWordmark && (
        <div className="flex flex-col leading-none">
          ...
          >
            WPGraphQL{" "}
            <span className={ideColor}>IDE</span>
          </span>
          {subLabel && (
            <span
...
//
// Favicon (no gradient at small size):
//   <WPGraphQLIDELogoMark size={16} showGradient={false} />
