...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        navy: { 950:"hsl(224,48%,7%)",900:"hsl(224,46%,9%)",800:"hsl(224,42%,13%)",700:"hsl(225,42%,18%)",600:"hsl(225,40%,22%)",500:"hsl(226,38%,27%)",400:"hsl(220,28%,36%)",300:"hsl(220,24%,51%)",200:"hsl(220,22%,67%)",100:"hsl(220,28%,82%)",50:"hsl(220,32%,93%)" },
        rose: {
          700:"#881337",600:"#9F1239",500:"#BE123C",400:"#E11D48",
          300:"#F43F5E", // PRIMARY
          200:"#FB7185",100:"#FDA4AF",50:"#FFF1F2",
        },
        "orange-wpg":{ 300:"#FF8C1A" },"cyan-rql":{ 300:"#00D4F5" },
        "violet-ide":{ 300:"#8B5CF6" },"emerald-acf":{ 300:"#10B981" },
      ...
      boxShadow:{
        "glow-sm":"0 0 12px -2px hsl(343 90% 60% / 0.28)","glow-md":"0 0 24px -4px hsl(343 90% 60% / 0.38)","glow-lg":"0 0 40px -8px hsl(343 90% 60% / 0.45)",
      ...
      keyframes:{
        ...
        "glow-pulse":{"0%,100%":{boxShadow:"0 0 8px -2px hsl(343 90% 60% / 0.2)"},"50%":{boxShadow:"0 0 20px -2px hsl(343 90% 60% / 0.55)"}},
        "purge-flash":{"0%":{opacity:"1"},"30%":{opacity:"0.2"},"60%":{opacity:"1"},"80%":{opacity:"0.4"},"100%":{opacity:"1"}},
      },
      animation:{
        ...
        "purge-flash":"purge-flash 0.5s ease-in-out", // cache purge feedback
      },
    },
  },
